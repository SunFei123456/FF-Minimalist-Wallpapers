...
const DecorativeShape = ({ className }) => (
  <div className={`${WallpaperStyle.shape} ${className}`}>
    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      <path fill="currentColor"  strokeWidth="1" d="M47.5,-61.5C59.2,-52.9,64.8,-35.6,68.2,-18.1C71.5,-0.6,72.7,17,65.8,30.4C58.9,43.8,44,52.9,28.5,58.7C13,64.5,-3,67,-17.9,63.3C-32.8,59.6,-46.5,49.8,-56.3,36.3C-66.1,22.8,-72,5.7,-69.1,-9.7C-66.3,-25,-54.7,-38.6,-41.5,-47.1C-28.3,-55.7,-13.5,-59.2,2.9,-62.8C19.4,-66.4,35.8,-70.1,47.5,-61.5Z" transform="translate(100 100)" />
    </svg>
  </div>
);
          ...
          <div className={WallpaperStyle.heroText}>
            ...
            >
              ...
              <div className={WallpaperStyle.searchTags}>
                ...
                <Tag className={WallpaperStyle.quickTag}>风景</Tag>
                <Tag className={WallpaperStyle.quickTag}>动漫</Tag>
                <Tag className={WallpaperStyle.quickTag}>简约</Tag>
              </div>
            </div>
          </div>
        ...
        <Card className={WallpaperStyle.tagsCard}>
          ...
          <div className={WallpaperStyle.tags}>
            <Tag
              size="large"
              color="violet"
              className={`${WallpaperStyle.tag} ${activeTag === '热门' ? WallpaperStyle.activeTag : ''}`}
            ...
            {tags.map((item) => (
              ...
              >
                <Tag
                  size="large"
                  color="violet"
                  className={`${WallpaperStyle.tag} ${activeTag === item.name ? WallpaperStyle.activeTag : ''}`}
